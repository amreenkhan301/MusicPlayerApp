...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Enchanted",4.5);
        album.addSong("Cardigan",3.5);
        album.addSong("August",5.0);
        albums.add(album);
        ...
        albums.get(0).addToPlayList("Enchanted",playList_1);
        albums.get(0).addToPlayList("Cardigan",playList_1);
        albums.get(0).addToPlayList("August",playList_1);
